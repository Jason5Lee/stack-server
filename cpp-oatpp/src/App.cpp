...
void run() {
    ...
    /* Create StackController and add all of its endpoints to router */
    router->addController(std::make_shared<StackController>());
    ...
    OATPP_LOGI("Stack Server", "Server running on port %s",
